...
////    {
////    	try {
////    	 Iterable<Tweet> tot=usermodelService.displayAllTweets();
...
//		
//    	return	usermodelService.getAllTweet();
//    		
//    	}
//    	
//    	
...
//    {
//    	try {
//    	 Optional<List<User>> a=usermodelService.searchbyUsername(username);
//		return new ResponseEntity<>(a,HttpStatus.OK);
//    	}
//    	catch(Exception e){
...
//    		@RequestHeader("Authorization") String token ,@RequestBody TweetPostRequest tweetreponse) throws TweetException
//    {
//    	try {
...
//    public void DeleteTweet(@PathVariable String username,@PathVariable long tweetId,
//    		@RequestHeader("Authorization") String token ) throws TweetException
//    {
////    	try {
//    	 usermodelService.deleteTweetofUser(username,tweetId);
////		return new ResponseEntity<>(a,HttpStatus.OK);
//    	}
////    	catch(Exception e){
////    		return new ResponseEntity<>("The above username and id is not found!!", HttpStatus.NOT_FOUND);
...
//    
  //method to like tweet of a user
	...
	public ResponseEntity<?> replyTweet(@RequestBody TweetReplyRequest replyRequest,
			@PathVariable long tweetId,@PathVariable String username,
    		@RequestHeader("Authorization") String token ) throws 
	 TweetException, UserException {
    	try {
